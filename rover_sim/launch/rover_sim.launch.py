...
def generate_launch_description():
    ...
    rover_sim_path = get_package_share_path('rover_sim')
    default_model_path = rover_sim_path / 'rover_urdf/rover.urdf.xacro'
    # default_rviz_config_path = dobot_viz_path / 'rviz/dobot_viz.rviz'
    params_path = rover_sim_path / 'params/rover.yaml'
